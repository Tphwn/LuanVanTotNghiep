        ...
        {cancelMode && (
          <div style={{
            ...
            <p style={{ fontSize: 13, fontWeight: 600, color: '#e05c5c', marginBottom: 8 }}>
              ⚠️ Hủy đơn sẽ thông báo cho khách hàng. Vui lòng nhập lý do rõ ràng.
            </p>
    ...
    <div>
      ...
      <div className="page-header">
        <div className="page-header-left">
          ...
          <p className="page-subtitle">Xem và can thiệp tất cả đơn đặt phòng trong hệ thống</p>
        </div>
      </div>
      ...
      {stats && (
        <div className="stats-grid" style={{ gridTemplateColumns: 'repeat(6,1fr)', marginBottom: 16 }}>
          {[
            { label: 'Tổng đơn',       value: stats.total,           color: '#3C7363' },
            { label: 'Chờ xác nhận',   value: stats.cho_xac_nhan,    color: '#b36b00' },
            { label: 'Đã xác nhận',    value: stats.da_xac_nhan,     color: '#0958d9' },
            { label: 'Hoàn thành',     value: stats.hoan_thanh,      color: '#52c41a' },
            { label: 'Đã hủy',         value: stats.da_huy,          color: '#e05c5c' },
            { label: 'DT tháng này',
              value: new Intl.NumberFormat('vi-VN', { notation: 'compact' }).format(stats.doanh_thu_thang) + '₫',
              color: '#7c3aed' },
          ].map(s => (
      ...
      <div className="content-card" style={{ marginBottom: 16 }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12, marginBottom: 12 }}>
          ...
          <div>
            ...
            <select style={{ ...inputSt, width: '100%' }} value={statusFilter} onChange={e => setStatusFilter(e.target.value)}>
          ...
          <div>
            ...
            <select style={{ ...inputSt, width: '100%' }} value={hotelFilter} onChange={e => setHotelFilter(e.target.value)}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr auto auto', gap: 12, alignItems: 'flex-end' }}>
          <div>
            ...
            <input type="date" style={{ ...inputSt, width: '100%' }} value={tuNgay} onChange={e => setTuNgay(e.target.value)} />
          </div>
          <div>
            <label style={{ fontSize: 12, color: '#5a7a72', display: 'block', marginBottom: 4 }}>Đến ngày</label>
            <input type="date" style={{ ...inputSt, width: '100%' }} value={denNgay} min={tuNgay} onChange={e => setDenNgay(e.target.value)} />
          </div>
      ...
      <div className="content-card">
        <div className="content-card-header">
          <h3 className="content-card-title">Danh sách đơn ({list.length})</h3>
        </div>
                ...
                return (
                  <tr key={b.ma_dat_phong}>
                    ...
                    <td>
                      ...
                      <div style={{ fontSize: 12, color: '#5a7a72' }}>{b.khach_hang?.ho_ten}</div>
                    </td>
                    <td>
