    ...
    <div style={{
     ...
     <Card style={{ width: '100%', maxWidth: '460px', textAlign: 'left' }}>
        ...
        <form onSubmit={handleSubmit}>
          <Input label="Họ tên" name="ho_ten" type="text"
          ...
          <Input label="Số điện thoại" name="so_dien_thoai" type="tel"
            value={formData.so_dien_thoai} onChange={handleChange}
            placeholder="09xxxxxxxx" required />

          <Input label="Mật khẩu" name="mat_khau" type="password"
            value={formData.mat_khau} onChange={handleChange}
            placeholder="Tối thiểu 6 ký tự" required />

          <Input label="Xác nhận mật khẩu" name="xac_nhan_mat_khau" type="password"
            value={formData.xac_nhan_mat_khau} onChange={handleChange}
